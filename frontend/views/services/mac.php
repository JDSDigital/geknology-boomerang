...
$this->title = 'Servicio técnico MAC';
?>
            ...
            <section class="slice sct-color-1 services-boxes">
                <div class="container">
                    ...
                    <div class="row row-no-padding">
                        <div class="col-lg-8 service-title right bg-secondary">
                            <div class="pl-2 pr-2">
                                <h3 class="heading heading-3 text-uppercase text-light m-1">Formateo Macbook - iMac</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Mantención térmica -->
                    <div class="row row-no-padding">
                        <div class="col-lg-8 ml-auto service-title left bg-secondary">
                            <div class="pl-2 pr-2">
                    ...
                    <!-- Cambio de disco duro macbook -->
                    <div class="row row-no-padding">
                        <div class="col-lg-8 service-title right bg-secondary">
                            <div class="pl-2 pr-2">
                                <h3 class="heading heading-3 text-uppercase text-light m-1">Cambio de disco duro Macbook - iMac</h3>
                            </div>
                        </div>
                    </div>
